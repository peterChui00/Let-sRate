...
//Matching keyword in database
$sql = "SELECT * FROM movies WHERE 
        title LIKE '%".$_POST['search']."%' OR
        description LIKE '%".$_POST['search']."%' OR
		genre LIKE '%".$_POST['search']."%' OR
		director LIKE '%".$_POST['search']."%' OR
		starring LIKE '%".$_POST['search']."%' OR
		language LIKE '%".$_POST['search']."%' OR
		running_time LIKE '%".$_POST['search']."%' OR
		release_date LIKE '%".$_POST['search']."%'";
